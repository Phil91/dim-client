...
public class ProcessExecutionService
{
    ...
    public async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        try
        {
            ...
            var executorRepositories = processServiceScope.ServiceProvider.GetRequiredService<IDimRepositories>();
            ...
            var outerLoopRepositories = outerLoopScope.ServiceProvider.GetRequiredService<IDimRepositories>();
